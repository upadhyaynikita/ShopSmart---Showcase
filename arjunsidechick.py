...
def start_chatbot_session():
    ...
    if st.button("Start ChatBOT", key="start_chatbot_button"):
...
#2nd tab
        ...
        # st.button("Publish all changes to Final Table")
...
"""
        ...
        # Button on the right side with red color
        #st.button("Publish all changes to Final Table", key="publish_button")
